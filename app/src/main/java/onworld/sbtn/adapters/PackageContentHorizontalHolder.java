 ...
 */
public class PackageContentHorizontalHolder extends PackageDetailViewHolder {
    private RecyclerView horizontalRecyclerView;
    private CategoryRecyclerHorizontalAdapter homeRecyclerHorizontalAdapter;
    private Context context;
    private int type;

    public PackageContentHorizontalHolder(Context context, View itemView, int type) {
        super(itemView);
