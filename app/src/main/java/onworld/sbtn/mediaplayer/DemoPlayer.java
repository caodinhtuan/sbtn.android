...
public class DemoPlayer implements ExoPlayer.Listener, ChunkSampleSource.EventListener,
  ...
  /**
   * Builds renderers for the menu_player.
   */
  public interface RendererBuilder {
    /**
     * Builds renderers for playback.
     *
     * @param player The menu_player for which renderers are being built. {@link DemoPlayer#onRenderers}
     ...
     * {@link DemoPlayer#onRenderersError} on the menu_player, which may have been released.
     */
    void cancel();
  }
   ...
   * error if the menu_player fails to recover. If this happens, {@link Listener#onError(Exception)}
   * will be invoked.
   */
