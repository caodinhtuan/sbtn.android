...
public class VideoCastManager extends BaseCastManager
    ...
    public static final String SINGER_MEDIA_INFO = "singermediainfo";
    public static final String EXTRA_MEDIA_ADV = "mediaAdv";
    public static final String EXTRA_MEDIA_SINGER="singermedia";
    ...
    public static final int ADVERTISEMENT_REQUEST_CODE = 1;
    ...
    public boolean isVotingAdvertisement;
    public boolean isAdvImage;
    public long skippableTimeVideoAdv;
    public int langOfContentId = 0;
    public int langSelectPosition = 0;
    public boolean isShowLanguageOfContent;
    public int karaoke;
    ...
    private Bundle mediaAdv;
    private Bundle singerBundle;
     ...
     */
    //OnMiniControllerChangedListener nguyenduylinh
    @Override
    public void onTargetActivityInvoked(Context context) throws
        ...
        intent.putExtra(EXTRA_MEDIA_ADV, mediaAdv);
        intent.putExtra(SINGER_MEDIA_INFO,singerBundle);
     ...
     */
    public void startVideoCastControllerActivity(Context context, Bundle mediaWrapper, Bundle mediaAdv, Bundle singerInfo, int position,
                                                 boolean shouldStart, JSONObject customData) {
        this.mediaAdv = mediaAdv;
        this.singerBundle = singerInfo;
        Intent intent = new Intent(context, VideoCastControllerActivity.class);
        intent.putExtra(EXTRA_MEDIA, mediaWrapper);
        intent.putExtra(EXTRA_MEDIA_ADV, mediaAdv);
        intent.putExtra(SINGER_MEDIA_INFO, singerInfo);
    ...
    public void startVideoCastControllerActivity(Context context, Bundle mediaWrapper, Bundle mediaAdv, Bundle singerInfo, int position,
                                                 boolean shouldStart) {
        startVideoCastControllerActivity(context, mediaWrapper, mediaAdv, singerInfo, position, shouldStart, null);
    }
    ...
    public void startVideoCastControllerActivity(Context context,
                                                 MediaInfo mediaInfo, MediaInfo mediaAdv, MediaInfo singerInfo, int position, boolean shouldStart) {
        startVideoCastControllerActivity(context, Utils.mediaInfoToBundle(mediaInfo), Utils.mediaInfoToBundle(mediaAdv), Utils.mediaInfoToBundle(singerInfo), position,
                shouldStart);
    }
